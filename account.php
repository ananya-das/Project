  ...
  <body>
    <div class = "wrapper">
      ...
      <div class = "body_content">
        <p class = "heading">JOIN US NOW</p>
        <p class = "subheading">Subscribe to our Newsletter! Don't worry, we only send them once a month! <span><a onclick = "document.getElementById('signin_wrapper').style.display = 'block'">Lets go!!</a></span></p>
        <div class = "form">
          <div class = "left">
          ...
          <div class = "left">
            ...
            <div class = "right">
              <div class = "signup_form">
                ...
                <br><br>
                <p>EPHEMERA STUDIO brings shoppers high quality, creative and affordable products through a wide range of product categories including the following:<br>
                  •	Journals (plain paper, grid paper).<br>
                  •	Handmade calendar cards.<br>
                  •	Wallpaper for desktop and mobile.<br>
                  •	Digital weekly and monthly planners for the app “GoodNotes” and “Notability”.
                </p>
                <a href = "" class = "subscribe_sub" onclick="alert('You are subscribed to us now!');">subscribe</a>
              </div>
