...
<div class="hello"></br></br></br></br></br></br></br></div>
<div class="container-fluid">
        ...
        <div class="col-md-4 offset-md-1 border rounded mt-5 bg-white h-25">
            ...
            <div class="pt-4">
                ...
                <div class="row price-details">
                    ...
                    <a href="test.php" class="btn btn-success btn-block" role="button">MAKE PAYMENT</a>
    ...
    <div class = "footer">
        <div class = "footer-links">
          <ul>
            <li><a class = "foot" href = "index.php">&copy; 2020 EPHEMERA STUDIOS.</a></li>
